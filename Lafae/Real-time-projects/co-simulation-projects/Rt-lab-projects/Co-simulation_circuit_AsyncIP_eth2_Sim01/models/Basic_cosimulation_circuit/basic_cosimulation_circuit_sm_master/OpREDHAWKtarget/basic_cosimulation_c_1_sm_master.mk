...
MODULES         = rt_matrx.c rt_printf.c rt_logging.c basic_cosimulation_c_1_sm_master_data.c basic_cosimulation_c_1_sm_master_offsets.c rtGetInf.c rtGetNaN.c rt_nonfinite.c OP_SEND.c RECV_Param.c rte_conversion.c rte_svpwm.c sfun_gen_async_ctrl.c sfun_recv_async.c sfun_send_async.c ssn_sfun_v1.c
